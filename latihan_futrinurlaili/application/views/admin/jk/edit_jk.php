				...
				<div class="card-body">
                    ...
                    <input type="hidden" name="id" value="<?= $id ?>">
						...
						<div class="form-group col-lg-12">
							...
							<input type="number" name="jumlah_kamar_disewa" class="form-control js-single" id="jumlah_kamar_disewa" value="<?= $ejk->jumlah_kamar_disewa  ?>">
						</div>
						<div class="form-group col-lg-12">
							<label>Jumlah kamar tersedia : </label>
							<input type="number" name="jumlah_kamar_tersedia" class="form-control js-single" id="jumlah_kamar_tersedia" value="<?= $ejk->jumlah_kamar_tersedia  ?>">
						</div>
						<div class="form-group col-lg-12">
							<label>Harga : </label>
