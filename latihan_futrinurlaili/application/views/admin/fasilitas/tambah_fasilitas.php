	...
	<div class="row">
		...
		<div class="col-lg-6">
			...
			<div class="card shadow mb-12">
				<div class="card-body">
					<form method="post" action="<?=base_url('index.php/FasilitasA/simpan_fasilitas')?>" enctype="multipart/form-data">
						<div class="form-group col-lg-12">
							<label>Nama Fasilitas: </label>
							<input type="text" name="nama_fasilitas" class="form-control js-single" id="nama_fasilitas">
						</div>
