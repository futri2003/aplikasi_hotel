...
class Admin_model extends CI_Model {
    ...
    public function simpan_jk()
    {
        ...
        $jumlah_kamar_disewa = $this->input->post('jumlah_kamar_disewa');
        ...
        $data = array(
            ...
            'jumlah_kamar_disewa' => $jumlah_kamar_disewa,
    ...
    {
        return $this->db->get_where('tbl_transaksi', array('id_transaksi' => $id))->result();
    }
